...
standalone union (`playwright.routine.config.js`, one worker — 760 executions
as of the Stage 6A1 review follow-up; re-check with `npm run test:routine:list` rather than
