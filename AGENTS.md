...
standalone union (`playwright.routine.config.js`, one worker — 946 executions
as of the Stage 6A5 CTA follow-up; re-check with `npm run test:routine:list` rather than
