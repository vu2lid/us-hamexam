...
standalone union (`playwright.routine.config.js`, one worker — 977 executions
as of the newcomer onboarding clarity follow-up; re-check with `npm run test:routine:list` rather than
