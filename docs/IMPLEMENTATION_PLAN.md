...
**Stage 5A (metadata/exam-config consolidation) is committed as `5148b3f`**
— see [POOL_STORAGE_PLAN.md](POOL_STORAGE_PLAN.md#stage-5a-outcome-committed-as-5148b3f)
for the field mapping, validator invariants, and verification detail. This is
one slice of Stage 5, not the full beta.2 release below.
