...
display labels) is committed as `8ea4ac1`** — see the Stage 5B1
...
`docs/POOL_STORAGE_PLAN.md`). Both are slices of Stage 5, not the full beta.2
release below.
