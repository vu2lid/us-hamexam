...
Last reviewed: September 19, 2026 (Stage 6A5 Getting Started guide).

**Current application priority:** Complete independent review of the uncommitted
Stage 6A5 work and resolve the standalone artifact's size margin
before any further feature work. Historical Stage 4 work: Stage 4A0 (canonical pool edition/revision
...
- [x] Stage 6A4: Help & About audit, "New to Amateur Radio?" newcomer
  ...
  rows below.
- [ ] Stage 6A5: a "Getting Started" newcomer guide reachable from Help —
  ...
  link section — implemented, uncommitted, pending independent review; see
  the Stage 6A5 execution-log row below. Built on top of the released
  `0.3.0-beta.4`; no version bump.
