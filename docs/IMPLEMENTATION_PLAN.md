...
Last reviewed: September 18, 2026 (beta.3 release preparation).
...
- [x] Stage 6A1: human-readable subelement/group titles in the scope
  ...
  — committed as `acf4198`; see the Stage 6A1
...
- [x] Stage 6A3: pause the study recall timer while the Settings drawer is
  ...
  committed as `441f035`; see the Stage 6A3 execution-log
  row below and [`docs/RESPONSIVE_LAYOUT_PLAN.md`](RESPONSIVE_LAYOUT_PLAN.md).
  Unrelated to scoped study; grouped here only by the task's own numbering.
